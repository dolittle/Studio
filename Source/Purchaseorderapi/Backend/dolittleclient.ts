...
export const buildConsumerClient = () => {
    return Client
        ...
        .withEventTypes(eventTypes => {
            ...
            eventTypes.register(PurchaseOrderLineSupplierUpdated);
            ...
            eventTypes.register(PurchaseOrderLineSupplierOrderIdUpdated);
            eventTypes.register(PurchaseOrderLinePriceUpdated);
            eventTypes.register(PurchaseOrderLineConfirmedPriceUpdated);
            eventTypes.register(PurchaseOrderLinePriceUnitOfMeasureUpdated);
            eventTypes.register(PurchaseOrderLinePriceQuantityUpdated);
...
export const buildProducerClient = () => {
    return Client
        .forMicroservice('f2586326-1057-495b-a12b-7f45193b9402')
        .withEventTypes(eventTypes => {
            eventTypes.register(PurchaseOrderCreated);
