    ...
    produce(payload: any, handledProps: string[] = []): any[] {
        ...
        if (payloadObj.document === 'MPLINE' && payloadObj.operation === 'U') {
            ...
            if (changeList.includes('PUST') && !handledProps.includes('PUST')) {
                ...
                const highestStatus = payloadObj.PUST;
                return [
                    new PurchaseOrderLineHighestStatusUpdated(
                        poNumber,
                        lineNumber,
                        subLineNumber,
                        itemNumber,
            ...
            if (changeList.includes('ITNO') && !handledProps.includes('ITNO')) {
                ...
                const itemNumber = payloadObj.ITNO;
                return [
                    new PurchaseOrderLineItemNumberUpdated(poNumber, lineNumber, subLineNumber, itemNumber),
            ...
            if (changeList.includes('SITE') && !handledProps.includes('SITE')) {
                ...
                return [
                    new PurchaseOrderLineSupplierItemIdUpdated(
                        poNumber,
                        lineNumber,
                        subLineNumber,
                        itemNumber,
            ...
            if (changeList.includes('PITT') && !handledProps.includes('PITT')) {
                ...
                return [
                    new PurchaseOrderLineItemDescriptionUpdated(
                        poNumber,
                        lineNumber,
                        subLineNumber,
                        itemNumber,
            ...
            if (changeList.includes('SORN') && !handledProps.includes('SORN')) {
                ...
                return [
                    new PurchaseOrderLineSupplierOrderIdUpdated(
                        poNumber,
                        lineNumber,
                        subLineNumber,
                        itemNumber,
            ...
            if (changeList.includes('PPUN') && !handledProps.includes('PPUN')) {
                ...
                return [
                    new PurchaseOrderLinePriceUnitOfMeasureUpdated(
                        poNumber,
                        lineNumber,
                        subLineNumber,
                        itemNumber,
