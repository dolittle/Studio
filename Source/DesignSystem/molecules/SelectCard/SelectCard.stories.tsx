...
metadata.parameters = {
    docs: {
        description: { component: `Selection cards are used when the user needs to select an option but needs additional information in order to make an informed decision. 
