...
**Styling:** The default style for alerts is outlined with an icon to indicate what severity level the alert is. Alerts can contain a title that provide additional information to the severity level. An alert can have an action such as a close button.
<br><br>**Severity types:** We have four severity types: error alerts, warning alerts, info alerts, and success alerts. 
...
- *Warning alerts* anticipate a change that will impact the system and therefore user’s experience. Inform but don’t alarm. If action is required from the user, clearly state what is needed and tell them what to expect after. Provide a cancel option if possible. 
- *Success alerts* indicate the system is functioning as it should.  
- *Info alerts* provide the user with additional helpful information that don’t require action.
`,
        }
    }
};
