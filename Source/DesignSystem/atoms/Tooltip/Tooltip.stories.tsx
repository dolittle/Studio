...
metadata.parameters = {
    docs: {
        ...
        Position tooltips so that they do not cover up the underlying content when activated. Common use cases for tooltips are icon only buttons, truncated labels on data grids, or to display
